...
Steedos_data.getSpaceUsers = function (spaceId){
  ...
  for(var i = 0 ; i < 1500 ; i++){
    ...
    userObject.organization = Steedos_data.getUserOrganization(spaceId, userObject.id);
    userObject.roles = Steedos_data.getUserRoles(spaceId, userObject.id);
...
Steedos_data.getUser = function (userId){

  if (typeof userId != "string"){

    return Steedos_data.getUsers(userId);
  
  }

  var spaceUsers = Steedos_data.getSpaceUsers("") , spaceUser = {};
...
Steedos_data.getUsers = function (userIds){

  var users = new Array();

  if(userIds){
    userIds.forEach(function(userId){
      users.push(Steedos_data.getUser(userId));
    });
  }
...
//获取用户岗位
Steedos_data.getUserRoles = function (spaceId, userId){
...
//获取用户部门
Steedos_data.getUserOrganization = function (spaceId, userId){
