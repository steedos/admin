    ...
    for(var i = 0; i < stFields.length; i ++){
      ...
      if (stField.type == 'table'){
        ...
        for(var si = 0 ; si < stField.sfields.length; si++){
          ...
          afFields[stField.code + ".$." + sstField.code] = new s_schema(String, sstField.code, sstField.type, sstField.options);
        ...
        afFields[stField.code] = new s_schema(String, label, stField.type, stField.options,stField.permission);
  ...
  function s_schema(schematype, label, fieldType, options, permission){
